...
### The references with the highest PageRank scores NOT found on Web of Science Core Collection
PageRank score calculated within the citation network of the dateset.
```{r,echo=FALSE}
...
### The references with the highest eigenvector centralities NOT found on the Web of Science Core Collection
```{r,echo=FALSE}
