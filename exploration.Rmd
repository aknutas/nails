...
head(citationsLit[, c("FullReference", "InDegree")], 25)
```
...
head(citationsRef[, c("FullReference", "InDegree")], 25)
```
...
head(citationsLit[, c("FullReference", "EigenvectorCentrality")], 25)
```
...
head(citationsRef[, c("FullReference", "EigenvectorCentrality")], 25)
```
